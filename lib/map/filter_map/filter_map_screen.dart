...
class MapScreenState extends State<FilterMapScreen> {
  ...
  void initState() {
    ...
    _filterMapBloc =
        FilterMapBloc(eventRepository: eventRepository, mapBloc: _mapBloc);
  }
  ...
  void _onButtonPress() {
    if (_dropdownCurrentDisciplineId == null) {
      ...
      _filterMapBloc
          .add(ApplyFilter(disciplineId: _dropdownCurrentDisciplineId));
    }
                    ...
                    child: StatefulBuilder(builder: (context, setState) {
                      return Form(
                        ...
                        children: [
                          ...
                          Padding(
                            padding:
                                EdgeInsets.only(top: 0.05 * screenSize.height),
                            child: ButtonTheme(
                              height: 40,
